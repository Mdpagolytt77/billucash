...
import { 
  ...
  ArrowLeft, Menu, X, Home, Wallet, Key, Palette, LogOut,
  RefreshCw
} from 'lucide-react';
...
const AdminAllUsers = () => {
  ...
  const sidebarItems = [
    ...
    { icon: Users, label: 'All Users', path: '/admin/users', active: true },
        ...
        <div className="p-4 pt-20">
          ...
          <nav className="space-y-1">
            ...
            <div className="pt-3 border-t border-border mt-3">
              <button 
                onClick={() => signOut()}
                className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-destructive hover:bg-destructive/10 text-sm"
              >
